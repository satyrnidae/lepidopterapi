...
import dev.satyrn.lepidoptera.quilt.network.play.QuiltPacketChannelsImpl;
...
public class MainEntrypoint implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        ServerPlayConnectionEvents.JOIN.register((handler, sender, server) -> {
            ...
            QuiltPacketChannelsImpl.QuiltServerPlayContext ctx =
                    new QuiltPacketChannelsImpl.QuiltServerPlayContext(handler.getPlayer(), server);
