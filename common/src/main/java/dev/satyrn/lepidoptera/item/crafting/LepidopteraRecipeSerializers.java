...
public final class LepidopteraRecipeSerializers {
    ...
    public static final DeferredRegister<RecipeSerializer<?>> RECIPE_SERIALIZERS = DeferredRegister.create(
            LepidopteraAPI.MOD_ID, Registries.RECIPE_SERIALIZER);

    static {
        CRAFTING_SHAPED_BREAKABLE = RECIPE_SERIALIZERS.register("crafting_shaped_breakable",
                () -> BreakableShapedRecipe.SERIALIZER);
        CRAFTING_SHAPELESS_BREAKABLE = RECIPE_SERIALIZERS.register("crafting_shapeless_breakable",
                () -> BreakableShapelessRecipe.SERIALIZER);
    }
