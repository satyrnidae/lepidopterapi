...
public class BreakableShapedRecipe extends ShapedRecipe {
     ...
     */
    public BreakableShapedRecipe(String group, CraftingBookCategory category,
            ShapedRecipePattern pattern, ItemStack result, int damage) {
     ...
     */
    public BreakableShapedRecipe(String group, CraftingBookCategory category,
            ShapedRecipePattern pattern, ItemStack result, int damage, boolean showNotification) {
    ...
    public NonNullList<ItemStack> getRemainingItems(CraftingInput input) {
        ...
        for (int i = 0; i < remaining.size(); i++) {
            ...
            if (!remainStack.isEmpty()) remaining.set(i, remainStack);
        }
    ...
    public static class Serializer implements RecipeSerializer<BreakableShapedRecipe> {
        ...
        /** {@inheritDoc} */
        @Override
        public MapCodec<BreakableShapedRecipe> codec() {
            return CODEC;
        }

        /** {@inheritDoc} */
        @Override
        public StreamCodec<RegistryFriendlyByteBuf, BreakableShapedRecipe> streamCodec() {
            return STREAM_CODEC;
        }

        private static BreakableShapedRecipe fromNetwork(RegistryFriendlyByteBuf buffer) {
            ...
            return new BreakableShapedRecipe(group, craftingBookCategory, shapedRecipePattern, itemStack, damage, showNotification);
        }

        private static void toNetwork(RegistryFriendlyByteBuf buffer, BreakableShapedRecipe recipe) {
