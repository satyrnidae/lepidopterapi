...
/**
 * Extension interface mixed into {@link net.minecraft.world.item.Item} to add crafting and fuel depletion behavior.
 *
 * <p>These methods are injected by the {@code ItemMixin} at runtime. The default implementations
 * throw {@link org.apache.commons.lang3.NotImplementedException} as stubs - calling them without the mixin applied
 * indicates a configuration error.</p>
 *
 * <p>Use {@link #cast(net.minecraft.world.item.Item)} to obtain a typed reference to the injected methods.</p>
 *
